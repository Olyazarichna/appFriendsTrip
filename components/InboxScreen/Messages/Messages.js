     ...
     return (
         <View style={styles.conteiner}>
            ...
            <Image style={styles.Image} source={{uri: user[0].avatar}}></Image>
                 ...
                 <TouchableOpacity onPress={() => setChat(false)} style={styles.buttonClose}> 
                 <AntDesign
                name="close" size={20}
             ...
             <ScrollView> 
                 ...
                 <View>
                     {conteiyerMasseges.map(massege =>
                         <MessageEl masseges={massege} />
                        )}
            ...
            <LinearGradient
             ...
             >
                 <View style={styles.form}>
                     ...
                     marginLeft={10}
                    title={
                    <Feather name="send" size={20} color={variables.labelButtonWhite} />
                         }
                     />
                 </View>
             </LinearGradient>   
